...
class Player {
  ...
  strike (player, enemy, attackDmg) {
    ...
    //  random number between 1 - 10 and that is damageAmount
...
class Game {
  ...
  let player1=new Player('MAX',100,10)
  let player2=new Player('REDDEX',100,10)
...
document.addEventListener('keydown', function(e) {
  ...
  if (e.key == "R" && p2.health > 0 && game.isOver == false ){
    p1.strike(p1, p2, p1.attackDmg)
